...
public class ServiceDetailAdapterActivity extends RecyclerView.Adapter<ServiceDetailAdapterActivity.ServiceViewHolder> {

    private Context context;
    private List<Service> serviceList;

    public ServiceDetailAdapterActivity(Context context, List<Service> serviceList) {
