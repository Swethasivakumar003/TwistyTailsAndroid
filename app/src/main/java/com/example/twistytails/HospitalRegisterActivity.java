                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (user != null) {
                                ...
                                DatabaseReference usersRef = FirebaseDatabase.getInstance().getReference().child("Hospital").child(user.getUid());
                                ...
                                Toast.makeText(HospitalRegisterActivity.this, "Registration successful.", Toast.LENGTH_SHORT).show();
                                // You can further update UI or navigate to other activities
                            }
                        } else {
                            // If registration fails, display a message to the user.
                            Toast.makeText(HospitalRegisterActivity.this, "Registration failed. " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
