...
public class signupadmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton = findViewById(R.id.cu_reg_btn);
        loginRedirectTextView = findViewById(R.id.cu_log_link_btn);
        ...
        loginRedirectTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(signupadmin.this, AdminLoginActivity.class));
                finish();
            }
        });
    }
